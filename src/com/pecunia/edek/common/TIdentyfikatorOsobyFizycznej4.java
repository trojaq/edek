...
public class TIdentyfikatorOsobyFizycznej4 extends Element {
	...
	public TIdentyfikatorOsobyFizycznej4() {
		super("OsobaFizyczna");
		// TODO Auto-generated constructor stub
	}

	public TIdentyfikatorOsobyFizycznej4(Map<String, String> data, String sufix) {
		this();
		setPESEL(data.get("PESEL" + sufix), data, false);
	...
	public TIdentyfikatorOsobyFizycznej4(Map<String, String> data, String sufix, boolean etd, boolean outeretd) {
		this();
		if(outeretd) namespace("etd", data);
		setPESEL(data.get("PESEL" + sufix), data, etd);
	...
	public void setPESEL(String value, Map<String, String> data, boolean etd) {
		if (!exists(value)) {
			return;
		}
